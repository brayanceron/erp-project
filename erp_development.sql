...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-08-2024 a las 01:27:59
...
INSERT INTO `departamento` (`id`, `name`, `phone`, `sucursal`, `description`, `email`) VALUES
('5yprgdfmlr', 'Departamento de marketing y comunicacion', '00000000', 'hnquadeupp', 'any', 'userspublicos@gmail.com'),
('hivch509zm', 'suc_0001', '00000000', 'q01gm0r7h6', 'any', 'userspublicos@gmail.com'),
('i483z0oyu5', 'Departamento de finanzas y contabilidad', '00000000', '0ydroy5cqn', 'departamento de prueba', 'userspublicos@gmail.com'),
('uq2ixanhjc', 'Departamento de gerencia', '00000000', 'm3l10q0k6x', 'pruebita pruebita', 'userspublicos@gmail.com');
...
('AGO', 'Angola', 'Africa', 'Central Africa', 1246700, 1975, 12878000, 38.3, 6648, 7984, 'Angola', 'Republic', 'Jos? Eduardo dos Santos', 56, 'AO'),
...
('ALB', 'Albania', 'Europe', 'Southern Europe', 28748, 1912, 3401200, 71.6, 3205, 2500, 'Shqip?ria', 'Republic', 'Rexhep Mejdani', 34, 'AL'),
...
('ARG', 'Argentina', 'South America', 'South America', 2780400, 1816, 37032000, 75.1, 340238, 323310, 'Argentina', 'Federal Republic', 'Fernando de la R?a', 69, 'AR'),
...
('ATF', 'French Southern territories', 'Antarctica', 'Antarctica', 7780, NULL, 0, NULL, 0, NULL, 'Terres australes fran?aises', 'Nonmetropolitan Territory of France', 'Jacques Chirac', NULL, 'TF'),
...
('AUT', 'Austria', 'Europe', 'Western Europe', 83859, 1918, 8091800, 77.7, 211860, 206025, '?sterreich', 'Federal Republic', 'Thomas Klestil', 1523, 'AT'),
('AZE', 'Azerbaijan', 'Asia', 'Middle East', 86600, 1991, 7734000, 62.9, 4127, 4100, 'Az?rbaycan', 'Federal Republic', 'Heyd?r ?liyev', 144, 'AZ'),
('BDI', 'Burundi', 'Africa', 'Eastern Africa', 27834, 1962, 6695000, 46.2, 903, 982, 'Burundi/Uburundi', 'Republic', 'Pierre Buyoya', 552, 'BI'),
('BEL', 'Belgium', 'Europe', 'Western Europe', 30518, 1830, 10239000, 77.8, 249704, 243948, 'Belgi?/Belgique', 'Constitutional Monarchy, Federation', 'Albert II', 179, 'BE'),
('BEN', 'Benin', 'Africa', 'Western Africa', 112622, 1960, 6097000, 50.2, 2357, 2141, 'B?nin', 'Republic', 'Mathieu K?r?kou', 187, 'BJ'),
('BFA', 'Burkina Faso', 'Africa', 'Western Africa', 274000, 1960, 11937000, 46.7, 2425, 2201, 'Burkina Faso', 'Republic', 'Blaise Compaor?', 549, 'BF'),
...
('BLR', 'Belarus', 'Europe', 'Eastern Europe', 207600, 1991, 10236000, 68, 13714, NULL, 'Belarus', 'Republic', 'Aljaksandr Luka?enka', 3520, 'BY'),
...
('BOL', 'Bolivia', 'South America', 'South America', 1098580, 1825, 8329000, 63.7, 8571, 7967, 'Bolivia', 'Republic', 'Hugo B?nzer Su?rez', 194, 'BO'),
...
('BVT', 'Bouvet Island', 'Antarctica', 'Antarctica', 59, NULL, 0, NULL, 0, NULL, 'Bouvet?ya', 'Dependent Territory of Norway', 'Harald V', NULL, 'BV'),
('BWA', 'Botswana', 'Africa', 'Southern Africa', 581730, 1966, 1622000, 39.3, 4834, 4935, 'Botswana', 'Republic', 'Festus G. Mogae', 204, 'BW'),
('CAF', 'Central African Republic', 'Africa', 'Central Africa', 622984, 1960, 3615000, 44, 1054, 993, 'Centrafrique/B?-Afr?ka', 'Republic', 'Ange-F?lix Patass?', 1889, 'CF'),
...
('CIV', 'C?te d?Ivoire', 'Africa', 'Western Africa', 322463, 1960, 14786000, 45.2, 11345, 10285, 'C?te d?Ivoire', 'Republic', 'Laurent Gbagbo', 2814, 'CI'),
('CMR', 'Cameroon', 'Africa', 'Central Africa', 475442, 1960, 15085000, 54.8, 9174, 8596, 'Cameroun/Cameroon', 'Republic', 'Paul Biya', 1804, 'CM'),
('COD', 'Congo, The Democratic Republic of the', 'Africa', 'Central Africa', 2344860, 1960, 51654000, 48.8, 6964, 2474, 'R?publique D?mocratique du Congo', 'Republic', 'Joseph Kabila', 2298, 'CD'),
...
('COL', 'Colombia', 'South America', 'South America', 1138910, 1810, 42321000, 70.3, 102896, 105116, 'Colombia', 'Republic', 'Andr?s Pastrana Arango', 2257, 'CO'),
('COM', 'Comoros', 'Africa', 'Eastern Africa', 1862, 1975, 578000, 60, 4401, 4361, 'Komori/Comores', 'Republic', 'Azali Assoumani', 2295, 'KM'),
('CPV', 'Cape Verde', 'Africa', 'Western Africa', 4033, 1975, 428000, 68.9, 435, 420, 'Cabo Verde', 'Republic', 'Ant?nio Mascarenhas Monteiro', 1859, 'CV'),
('CRI', 'Costa Rica', 'North America', 'Central America', 51100, 1821, 4023000, 75.8, 10226, 9757, 'Costa Rica', 'Republic', 'Miguel ?ngel Rodr?guez Echeverr?a', 584, 'CR'),
...
('CYP', 'Cyprus', 'Asia', 'Middle East', 9251, 1960, 754700, 76.7, 9333, 8246, 'K?pros/Kibris', 'Republic', 'Glafkos Klerides', 2430, 'CY'),
('CZE', 'Czech Republic', 'Europe', 'Eastern Europe', 78866, 1993, 10278100, 74.5, 55017, 52037, '?esko', 'Republic', 'V?clav Havel', 3339, 'CZ'),
...
('DOM', 'Dominican Republic', 'North America', 'Caribbean', 48511, 1844, 8495000, 73.2, 15846, 15076, 'Rep?blica Dominicana', 'Republic', 'Hip?lito Mej?a Dom?nguez', 587, 'DO'),
('DZA', 'Algeria', 'Africa', 'Northern Africa', 2381740, 1962, 31471000, 69.7, 49982, 46966, 'Al-Jaza?ir/Alg?rie', 'Republic', 'Abdelaziz Bouteflika', 35, 'DZ'),
...
('ESP', 'Spain', 'Europe', 'Southern Europe', 505992, 1492, 39441700, 78.8, 553233, 532031, 'Espa?a', 'Constitutional Monarchy', 'Juan Carlos I', 653, 'ES'),
...
('FRO', 'Faroe Islands', 'Europe', 'Nordic Countries', 1399, NULL, 43000, 78.4, 0, NULL, 'F?royar', 'Part of Denmark', 'Margrethe II', 901, 'FO'),
...
('GIN', 'Guinea', 'Africa', 'Western Africa', 245857, 1958, 7430000, 45.6, 2352, 2383, 'Guin?e', 'Republic', 'Lansana Cont?', 926, 'GN'),
...
('GNB', 'Guinea-Bissau', 'Africa', 'Western Africa', 36125, 1974, 1213000, 49, 293, 272, 'Guin?-Bissau', 'Republic', 'Kumba Ial?', 927, 'GW'),
...
('GRC', 'Greece', 'Europe', 'Southern Europe', 131626, 1830, 10545700, 78.4, 120724, 119946, 'Ell?da', 'Republic', 'Kostis Stefanopoulos', 2401, 'GR'),
('GRD', 'Grenada', 'North America', 'Caribbean', 344, 1974, 94000, 64.5, 318, NULL, 'Grenada', 'Constitutional Monarchy', 'Elisabeth II', 916, 'GD'),
('GRL', 'Greenland', 'North America', 'North America', 2166090, NULL, 56000, 68.1, 0, NULL, 'Kalaallit Nunaat/Gr?nland', 'Part of Denmark', 'Margrethe II', 917, 'GL'),
...
('GUF', 'French Guiana', 'South America', 'South America', 90000, NULL, 181000, 76.1, 681, NULL, 'Guyane fran?aise', 'Overseas Department of France', 'Jacques Chirac', 3014, 'GF'),
...
('HND', 'Honduras', 'North America', 'Central America', 112088, 1838, 6485000, 69.9, 5333, 4697, 'Honduras', 'Republic', 'Carlos Roberto Flores Facuss?', 933, 'HN'),
('HRV', 'Croatia', 'Europe', 'Southern Europe', 56538, 1991, 4473000, 73.7, 20208, 19300, 'Hrvatska', 'Republic', '?tipe Mesic', 2409, 'HR'),
('HTI', 'Haiti', 'North America', 'Caribbean', 27750, 1804, 8222000, 49.2, 3459, 3107, 'Ha?ti/Dayti', 'Republic', 'Jean-Bertrand Aristide', 929, 'HT'),
('HUN', 'Hungary', 'Europe', 'Eastern Europe', 93030, 1918, 10043200, 71.4, 48267, 45914, 'Magyarorsz?g', 'Republic', 'Ferenc M?dl', 3483, 'HU'),
...
('IRL', 'Ireland', 'Europe', 'British Islands', 70273, 1921, 3775100, 76.8, 75921, 73132, 'Ireland/?ire', 'Republic', 'Mary McAleese', 1447, 'IE'),
...
('ISL', 'Iceland', 'Europe', 'Nordic Countries', 103000, 1944, 279000, 79.4, 8255, 7474, '?sland', 'Republic', '?lafur Ragnar Gr?msson', 1449, 'IS'),
...
('KHM', 'Cambodia', 'Asia', 'Southeast Asia', 181035, 1953, 11168000, 56.5, 5121, 5670, 'K?mpuch?a', 'Constitutional Monarchy', 'Norodom Sihanouk', 1800, 'KH'),
...
('LBN', 'Lebanon', 'Asia', 'Middle East', 10400, 1941, 3282000, 71.3, 17121, 15129, 'Lubnan', 'Republic', '?mile Lahoud', 2438, 'LB'),
...
('LUX', 'Luxembourg', 'Europe', 'Western Europe', 2586, 1867, 435700, 77.1, 16321, 15519, 'Luxembourg/L?tzebuerg', 'Constitutional Monarchy', 'Henri', 2452, 'LU'),
...
('MEX', 'Mexico', 'North America', 'Central America', 1958200, 1810, 98881000, 71.5, 414972, 401461, 'M?xico', 'Federal Republic', 'Vicente Fox Quesada', 2515, 'MX'),
...
('MLI', 'Mali', 'Africa', 'Western Africa', 1240190, 1960, 11234000, 46.7, 2642, 2453, 'Mali', 'Republic', 'Alpha Oumar Konar?', 2482, 'ML'),
...
('MOZ', 'Mozambique', 'Africa', 'Eastern Africa', 801590, 1975, 19680000, 37.5, 2891, 2711, 'Mo?ambique', 'Republic', 'Joaqu?m A. Chissano', 2698, 'MZ'),
...
('NCL', 'New Caledonia', 'Oceania', 'Melanesia', 18575, NULL, 214000, 72.8, 3563, NULL, 'Nouvelle-Cal?donie', 'Nonmetropolitan Territory of France', 'Jacques Chirac', 3493, 'NC'),
...
('NIC', 'Nicaragua', 'North America', 'Central America', 130000, 1838, 5074000, 68.7, 1988, 2023, 'Nicaragua', 'Republic', 'Arnoldo Alem?n Lacayo', 2734, 'NI'),
...
('PAN', 'Panama', 'North America', 'Central America', 75517, 1903, 2856000, 75.5, 9131, 8700, 'Panam?', 'Republic', 'Mireya Elisa Moscoso Rodr?guez', 2882, 'PA'),
('PCN', 'Pitcairn', 'Oceania', 'Polynesia', 49, NULL, 50, NULL, 0, NULL, 'Pitcairn', 'Dependent Territory of the UK', 'Elisabeth II', 2912, 'PN'),
('PER', 'Peru', 'South America', 'South America', 1285220, 1821, 25662000, 70, 64140, 65186, 'Per?/Piruw', 'Republic', 'Valentin Paniagua Corazao', 2890, 'PE'),
...
('PRT', 'Portugal', 'Europe', 'Southern Europe', 91982, 1143, 9997600, 75.8, 105954, 102133, 'Portugal', 'Republic', 'Jorge Samp?io', 2914, 'PT'),
('PRY', 'Paraguay', 'South America', 'South America', 406752, 1811, 5496000, 73.7, 8444, 9555, 'Paraguay', 'Republic', 'Luis ?ngel Gonz?lez Macchi', 2885, 'PY'),
('PSE', 'Palestine', 'Asia', 'Middle East', 6257, NULL, 3101000, 71.4, 4173, NULL, 'Filastin', 'Autonomous Area', 'Yasser (Yasir) Arafat', 4074, 'PS'),
('PYF', 'French Polynesia', 'Oceania', 'Polynesia', 4000, NULL, 235000, 74.8, 818, 781, 'Polyn?sie fran?aise', 'Nonmetropolitan Territory of France', 'Jacques Chirac', 3016, 'PF'),
('QAT', 'Qatar', 'Asia', 'Middle East', 11000, 1971, 599000, 72.4, 9472, 8920, 'Qatar', 'Monarchy', 'Hamad ibn Khalifa al-Thani', 2973, 'QA'),
('REU', 'R?union', 'Africa', 'Eastern Africa', 2510, NULL, 699000, 72.7, 8287, 7988, 'R?union', 'Overseas Department of France', 'Jacques Chirac', 3017, 'RE'),
('ROM', 'Romania', 'Europe', 'Eastern Europe', 238391, 1878, 22455500, 69.9, 38158, 34843, 'Rom?nia', 'Republic', 'Ion Iliescu', 3018, 'RO'),
...
('SEN', 'Senegal', 'Africa', 'Western Africa', 196722, 1960, 9481000, 62.2, 4787, 4542, 'S?n?gal/Sounougal', 'Republic', 'Abdoulaye Wade', 3198, 'SN'),
...
('SLV', 'El Salvador', 'North America', 'Central America', 21041, 1841, 6276000, 69.7, 11863, 11203, 'El Salvador', 'Republic', 'Francisco Guillermo Flores P?rez', 645, 'SV'),
...
('STP', 'Sao Tome and Principe', 'Africa', 'Central Africa', 964, 1975, 147000, 65.3, 6, NULL, 'S?o Tom? e Pr?ncipe', 'Republic', 'Miguel Trovoada', 3172, 'ST'),
...
('SYC', 'Seychelles', 'Africa', 'Eastern Africa', 455, 1976, 77000, 70.4, 536, 539, 'Sesel/Seychelles', 'Republic', 'France-Albert Ren?', 3206, 'SC'),
...
('TCD', 'Chad', 'Africa', 'Central Africa', 1284000, 1960, 7651000, 50.5, 1208, 1102, 'Tchad/Tshad', 'Republic', 'Idriss D?by', 3337, 'TD'),
('TGO', 'Togo', 'Africa', 'Western Africa', 56785, 1960, 4629000, 54.7, 1449, 1400, 'Togo', 'Republic', 'Gnassingb? Eyad?ma', 3332, 'TG'),
...
('TJK', 'Tajikistan', 'Asia', 'Southern and Central Asia', 143100, 1991, 6188000, 64.1, 1990, 1056, 'To?ikiston', 'Republic', 'Emomali Rahmonov', 3261, 'TJ'),
...
('TKM', 'Turkmenistan', 'Asia', 'Southern and Central Asia', 488100, 1991, 4459000, 60.9, 4397, 2000, 'T?rkmenostan', 'Republic', 'Saparmurad Nijazov', 3419, 'TM'),
('TMP', 'East Timor', 'Asia', 'Southeast Asia', 14874, NULL, 885000, 46, 0, NULL, 'Timor Timur', 'Administrated by the UN', 'Jos? Alexandre Gusm?o', 1522, 'TP'),
...
('TUR', 'Turkey', 'Asia', 'Middle East', 774815, 1923, 66591000, 71, 210721, 189122, 'T?rkiye', 'Republic', 'Ahmet Necdet Sezer', 3358, 'TR'),
...
('URY', 'Uruguay', 'South America', 'South America', 175016, 1828, 3337000, 75.2, 20831, 19967, 'Uruguay', 'Republic', 'Jorge Batlle Ib??ez', 3492, 'UY'),
...
('VAT', 'Holy See (Vatican City State)', 'Europe', 'Southern Europe', 0.4, 1929, 1000, NULL, 9, NULL, 'Santa Sede/Citt? del Vaticano', 'Independent Church State', 'Johannes Paavali II', 3538, 'VA'),
...
('VEN', 'Venezuela', 'South America', 'South America', 912050, 1811, 24170000, 73.1, 95023, 88434, 'Venezuela', 'Federal Republic', 'Hugo Ch?vez Fr?as', 3539, 'VE'),
...
('VNM', 'Vietnam', 'Asia', 'Southeast Asia', 331689, 1945, 79832000, 69.3, 21929, 22834, 'Vi?t Nam', 'Socialistic Republic', 'Tr?n Duc Luong', 3770, 'VN'),
...
('YUG', 'Yugoslavia', 'Europe', 'Southern Europe', 102173, 1918, 10640000, 72.4, 17000, NULL, 'Jugoslavija', 'Federal Republic', 'Vojislav Ko?tunica', 1792, 'YU'),
...
INSERT INTO `sucursal` (`id`, `name`, `country`, `city`, `postalcode`, `address`, `phone`, `description`) VALUES
('0ydroy5cqn', 'Demo_I', 'ECU', 602, '00000', 'demo_0001', '00000000', 'demo'),
('63li16duu9', 'temp_0002', 'ECU', 602, '00000', 'temp_0002', '00000000', 'any'),
('hnquadeupp', 'test_0003', 'ECU', 593, '00000', 'test_0003', '00000000', 'any'),
('m3l10q0k6x', 'temp_0001', 'CAN', 1818, '00000', 'temp_0001', '00000000', 'anythiny'),
('q01gm0r7h6', 'test_0002', 'CHL', 554, '520001', 'test_0001', '00000000', 'any'),
('ye830uactj', 'test_0001', 'BWA', 205, '00000', 'test_0001', '00000000', 'any');
...
ALTER TABLE `departamento`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sucursaltTodeparatementos` (`sucursal`);
...
--
ALTER TABLE `departamento`
  ADD CONSTRAINT `sucursaltTodeparatementos` FOREIGN KEY (`sucursal`) REFERENCES `sucursal` (`id`);
